...
（1）在選擇使用棧板工作站後，點擊擴展I/O配置，可根據對應功能及與PLC的I/O介面實際接線，自定義選擇棧板功能的I/O信號配置，如圖2-3為棧板工作站預設接線配置。
...
（2）若選擇不使用棧板工作站，則預設使用控制箱I/O信號，根據對應功能及與控制箱I/O介面的實際接線，自定義選擇棧板功能的I/O信號配置，如圖2-4為無棧板工作站（使用控制箱I/O）預設接線配置。
