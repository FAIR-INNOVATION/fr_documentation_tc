...
.. list-table:: 
   ...
   * - 20
     - 外部急停輸入訊號1
     - 機器人外部急停輸入訊號1，①僅在QNX下顯示。 ②LINUX下可在「初始設定」->「安全性」->"I/O安全性"->「DIO安全功能配置」介面進行相關配置
   * - 21
     - 外部急停輸入訊號2
     - 機器人外部急停輸入訊號2，①僅在QNX下顯示。 ②LINUX下可在「初始設定」->「安全性」->"I/O安全性"->「DIO安全功能配置」介面進行相關配置
   * - 22
     - 一級縮減模式
     - 機器人一級縮減模式，①僅以QNX顯示。 ②LINUX下可在「初始設定」->「安全性」->"I/O安全性"->「DIO安全功能配置」介面進行相關配置
   * - 23
     - 二級縮減模式
     - 機器人二級縮減模式，①僅在QNX下顯示。 ②LINUX下可在「初始設定」->「安全性」->"I/O安全性"->「DIO安全功能配置」介面進行相關配置
   * - 24
     - 三級縮減模式（停止）
     - 機器人三級縮減模式（停止），①僅在QNX下顯示。 ②LINUX下可在「初始設定」->「安全性」->"I/O安全性"->「DIO安全功能配置」介面進行相關配置
   * - 25
     - 恢復焊接
     - 機器人發生焊接中斷後，恢復焊接操作訊號
   * - 26
...
.. list-table:: 
   ...
   * - 20
     - 急停輸出訊號1
     - 機器人急停輸出訊號1，①僅在QNX下顯示。 ②LINUX下可在「初始設定」->「安全性」->"I/O安全性"->「DIO安全功能配置」介面進行相關配置
   * - 21
     - 急停輸出訊號2
     - 機器人急停輸出訊號2，①僅在QNX下顯示。 ②LINUX下可在「初始設定」->「安全性」->"I/O安全性"->「DIO安全功能配置」介面進行相關配置
   * - 22
     - Lua腳本程式運行/停止
     - 機器人運動Lua腳本程式運作/停止訊號
   * - 23
     - 安全狀態輸出
     - 機器人安全狀態輸出訊號，①僅在QNX下顯示。 ②LINUX下可在「初始設定」->「安全性」->"I/O安全性"->「DIO安全功能配置」介面進行相關配置
   * - 24
     - 保護性停止狀態輸出
     - 機器人保護性停止狀態輸出訊號，①僅在QNX下顯示。 ②LINUX下可在「初始設定」->「安全性」->"I/O安全性"->「DIO安全功能配置」介面進行相關配置
   * - 25
     - 機器人運動中
     - 機器人運動中狀態訊號，①僅在QNX下方顯示。 ②LINUX下可在「初始設定」->「安全性」->"I/O安全性"->「DIO安全功能配置」介面進行相關配置
   * - 26
     - 機器人縮減模式
     - 機器人縮減模式訊號，①僅在QNX下顯示。 ②LINUX下可在「初始設定」->「安全性」->"I/O安全性"->「DIO安全功能配置」介面進行相關配置
   * - 27
     - 機器人非縮減模式
     - 機器人非縮減模式訊號，①僅在QNX下顯示。 ②LINUX下可在「初始設定」->「安全性」->"I/O安全性"->「DIO安全功能配置」介面進行相關配置
   * - 28
     - 預留
     - 預留
   * - 29
...
.. centered:: 圖表 6.4‑7 上電期間控制箱DO輸出配置
