...
.. 在「機器人設定」中的「DI設定」下，點擊不同的DI下拉框，可以設定輔助拖動開啟、輔助關閉和輔助拖動開啟/關閉

.. - 控制箱DI功能設定力感測器拖動功能，可直接透過控制箱DI輸入進行力感測器拖動。
.. - 機器人末端DI功能設定力感測器拖動功能,可透過末端DI輸入進行力感測器拖動
.. - 機器人拖動模式下TPD軌跡記錄基礎上增加力感測器輔助拖動模式得TPD軌跡記錄，實現更柔順得TPD軌跡拖動。

.. .. image:: application/271.png
..    :width: 4in
..    :align: center

.. .. centered:: 圖表 4.9‑35 力感測器輔助拖動功能設定

.. .. important:: 當檢測到力感測器拖動開啟狀態時，機器人切換至力感測器拖動狀態；當檢測到力感測器拖動關閉DI狀態時，關閉力感測器拖動狀態；
