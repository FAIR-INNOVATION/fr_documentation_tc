...
2. 登入帳號admin，密碼123。進入頁面，點選系統設定-通用設置，確認示教器為啟用狀態。
...
1. 開啟右下角軟鍵盤，點選輸入框，例如點選使用者名稱輸入框。

2. 切換中文拼音輸入法。

點選兩次CTRL鍵，按鍵狀態變紅色，點選空格進行選擇輸入法，以下為中文輸入法。
...
點選兩次CTRL鍵，按鍵狀態變紅色，點選空格進行選擇輸入法，以下為英文輸入法。
...
啟用示教器後，在登入介面會觸發示教器與webApp語言校驗，當示教器語言與webApp語言不一致時，出現以下提示。

.. image:: teach_pendant/008.png
   :width: 6in
   :align: center

.. centered:: 圖表 16.2‑7 示教器與webApp語言不一致提示