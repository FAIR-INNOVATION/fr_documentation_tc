...
.. centered:: 圖表 1.2-2 控制箱外形尺寸-安裝孔尺寸1

.. image:: installation/150.png
   :width: 6in
   :align: center

.. centered:: 圖表 1.2-3 控制箱外形尺寸-安裝孔尺寸2

.. note:: 
  1. 標註尺寸孔為可用安裝孔；
  2. 安裝孔共16顆，分佈在控制箱左右兩側，每側8顆；
  3. 安裝孔所用螺絲規格為M3，螺距0.5mm；
  4. 螺絲旋入控制箱鈑金外殼的深度≤5mm；
  5. 建議安裝扭力0.6Nm，最大安裝扭力0.84Nm。

:download:`控制箱外形尺寸-安裝孔尺寸 <../_static/_doc/控制箱外形尺寸-安装孔尺寸.zip>`
