...
+                      +-------------------------------------------------+----------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------+
|                      | exaxis配置文件版本错误                          | 1.exaxis.config設定檔版本錯誤;                                                                                 | 聯絡售後人員                                                                |
+                      +-------------------------------------------------+----------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------+
...
- 點擊“傳送檔案”，當進度條顯示100%時，表示已經完成發送升級檔案。  点击“发送文件”，当进度条显示100%时，表示已经完成发送升级文件。

**Step5：升級驗證**，系統重啟上電，在“維護信息”欄，選擇“查詢末端板固件版本信息”，在“接收數據區”會顯示固件版本信息，如果和升級的文件版本信息一致，說明昇級成功，否則升級失敗.
